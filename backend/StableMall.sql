...
CREATE TABLE `oms_cart_item`  (
  ...
  `checked` smallint(1) NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of oms_cart_item
-- ----------------------------
INSERT INTO `oms_cart_item` VALUES (1, 3, 1, NULL, 100, 4999.00, 'https://resource.smartisan.com/resource/71432ad30288fb860a4389881069b874.png', 'Apple iPhone XS Max (A2104)', NULL, '1', '测试用户', '2020-06-18 22:49:42', NULL, 0, 3, 3, '3', '[\r\n    {\r\n        \"key\": \"颜色\",\r\n        \"value\": \"银色\"\r\n    },\r\n    {\r\n        \"key\": \"容量\",\r\n        \"value\": \"128G\"\r\n    }\r\n]', NULL, NULL);
INSERT INTO `oms_cart_item` VALUES (2, 1, NULL, 1, 1, 1299.00, 'https://resource.smartisan.com/resource/71432ad30288fb860a4389881069b874.png', '畅呼吸智能空气净化器', NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '标准版 白色', 99, 0);
INSERT INTO `oms_cart_item` VALUES (3, 2, NULL, 1, 1, 29.00, 'https://yanxuan.nosdn.127.net/e9cecc7cb24a8d7745da1c99b87dde08.png', '丛林系列·缝线笔记本 4本装', NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '丛林系列', 99, 1);
INSERT INTO `oms_cart_item` VALUES (8, 3, NULL, 1, 1, 1.00, 'https://img11.360buyimg.com/n1/s450x450_jfs/t1/62813/33/2131/584186/5d079803E03084b0d/2b4970456b7bf49f.png', 'Apple iPhone XS Max (A2104)', NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, ' 银色 64GB', 100, 1);
...
INSERT INTO `oms_order` VALUES (3, 1, '2006251526281', NULL, NULL, 1.00, 11.00, 10.00, NULL, NULL, 2, NULL, NULL, 'Exrick', '17621230884', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL);
...
INSERT INTO `oms_order_item` VALUES (3, NULL, '2006251526281', 8, 'https://img11.360buyimg.com/n1/s450x450_jfs/t1/62813/33/2131/584186/5d079803E03084b0d/2b4970456b7bf49f.png', 'Apple iPhone XS Max (A2104)', NULL, NULL, 1.00, 1, NULL, NULL, NULL, ' 银色 64GB');
...
CREATE TABLE `pms_brand`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_feight_template`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '运费模版' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for pms_platform_statistics
-- ----------------------------
DROP TABLE IF EXISTS `pms_platform_statistics`;
CREATE TABLE `pms_platform_statistics`  (
  `id` int(11) NOT NULL,
  `datetime` datetime(0) NULL DEFAULT NULL,
  `tody_sale` int(8) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_platform_statistics
-- ----------------------------
INSERT INTO `pms_platform_statistics` VALUES (1, '2020-06-22 15:52:05', 999);
INSERT INTO `pms_platform_statistics` VALUES (2, '2020-06-23 15:52:15', 599);
INSERT INTO `pms_platform_statistics` VALUES (3, '2020-06-24 15:52:23', 2999);
INSERT INTO `pms_platform_statistics` VALUES (4, '2020-06-25 15:52:35', 1999);
...
-- ----------------------------
INSERT INTO `pms_product` VALUES (1, 1, 9, NULL, NULL, '潮流男T', 'https://img.yzcdn.cn/upload_files/2017/01/16/14845328884446826.jpg', '1', 0, 1, 0, 1, 0, 1, 55, 19.90, '潮流男装，每个男生都必须拥有', '一套服装，一种风姿，一个个性。', 99.90, 99, 10, '件', 10.00, 0, '1,2,3', '男T', NULL, 'https://www.shuaigetu.net/uploads/img1/20171127/66d47ceb74064155974d18bd99ee110e.jpg', NULL, '', NULL, NULL, '以纯', 'T恤', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性参数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品属性分类表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存储产品参数信息的表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品的分类和属性的关系表，用于设置分类筛选条件（只支持一级分类）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_shop`  (
  ...
  `is_valid` smallint(6) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of pms_shop
-- ----------------------------
INSERT INTO `pms_shop` VALUES (800, 1, '以纯男装店', 1, 1);
INSERT INTO `pms_shop` VALUES (600, 2, '锤子科技官方旗舰店', 2, 1);
INSERT INTO `pms_shop` VALUES (11000, 3, '苹果旗舰店', 1, 1);
INSERT INTO `pms_shop` VALUES (123, 123, '23asdasd 1', 1511, 1);

-- ----------------------------
-- Table structure for pms_shopsale
-- ----------------------------
DROP TABLE IF EXISTS `pms_shopsale`;
CREATE TABLE `pms_shopsale`  (
  `time` datetime(0) NOT NULL,
  `dailysale` int(11) NULL DEFAULT NULL,
  `id` bigint(20) NOT NULL,
  PRIMARY KEY (`time`, `id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_shopsale
-- ----------------------------
INSERT INTO `pms_shopsale` VALUES ('2020-06-22 20:29:09', 600, 14);
INSERT INTO `pms_shopsale` VALUES ('2020-06-22 20:29:52', 500, 13);
INSERT INTO `pms_shopsale` VALUES ('2020-06-23 20:22:31', 900, 14);
INSERT INTO `pms_shopsale` VALUES ('2020-06-23 20:29:39', 400, 13);
INSERT INTO `pms_shopsale` VALUES ('2020-06-24 20:22:16', 1000, 14);
INSERT INTO `pms_shopsale` VALUES ('2020-06-24 20:29:28', 300, 13);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku的库存' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  `default_status` smallint(6) NULL DEFAULT NULL COMMENT '是否为默认',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员收货地址表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员统计信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member_statistics_info
-- ----------------------------
INSERT INTO `ums_member_statistics_info` VALUES (1, 1, 0.00, 0, 0, 0, 0, 0, 0, '2020-06-25 01:23:55');
