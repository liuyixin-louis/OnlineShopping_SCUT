...
def admin_product(product_id=0):
    ...
    if request.method == 'POST':
        ...
        new_product = PmsProduct(id=id,pic=pic,name= name,brand_name= brand_name,price= price,product_sn= product_sn,publish_status= publish_status,new_status=new_status,recommand_status=recommand_status,sort=sort,sale=sale)
