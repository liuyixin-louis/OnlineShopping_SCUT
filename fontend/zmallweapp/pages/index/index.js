...
Page({
  ...
  onShow: function () { 
    ...
    wx.request({
      url: 'http://localhost:5000/get_banner',
      success(res){
        that.setData({
          banner:res.data.res
        })
    ...
    wx.request({
      url: 'http://localhost:5000/get_hot',success(res){
  ...
  handleClick: function (e) {
    ...
    clickHeader:function (e) {
      let data = e.currentTarget.dataset.value;
      wx.navigateTo({
        url: '/pages/promotion/promotion?id=' + data.id
      });
    }
  }
  )