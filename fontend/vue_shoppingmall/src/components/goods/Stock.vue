  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="DataList" style="width: 100%" border>
        ...
        <el-table-column prop="sku_code" label="SKU编号">
        </el-table-column>
        <el-table-column prop="price" label="价格">
        </el-table-column>
        <el-table-column prop="low_stock" label="报警库存">
        </el-table-column>
        <el-table-column prop="sale" label="销量">
        </el-table-column>
        <el-table-column prop="sp_data" label="属性值">
        </el-table-column>
...
export default {
  ...
  methods: {
    async getDataList () {
      const { data: res } = await this.$http.get('admin/stoke')
